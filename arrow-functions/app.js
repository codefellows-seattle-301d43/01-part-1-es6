...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe);
//arrow functions do not bind this so you shouldn't use arrow function for constructors
...
// TODO: Uncomment the following line of code to see the output in the browser console
//same thing here too? because the contextual this loses meaning
...
// Student{name: "Joe", age: "Schmoe", hometown: 100} it is object created from line 149
// 2. What is "this" when joe.scopeArrow() is invoked?
// Window{postMessage: ƒ, blur: ƒ, focus: ƒ, close: ƒ, frames: Window,…}
// it is the window object because it's globally scoped?
// 3. Explain why "this" is different when an arrow function is used.
// this with an arrow function bubbles up to the global window object because
// it is the next-nearest enclosing scope