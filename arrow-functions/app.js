...
// The student object with the first name 'Joe'.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The window object.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have thier own 'this' binding and use the binding of the nearest enclosing scope, which in this case would be the global window object.
