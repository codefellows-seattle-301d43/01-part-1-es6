...
// We can't use arrow functions to define constructors or as prototype functions because 'this' inside arrow functions doesn't point to an instance we are about to create.
