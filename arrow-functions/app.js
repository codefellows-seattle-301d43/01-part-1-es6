...
// "this" is that specific instance of Joe stored in joe.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" is the this of the containing context since arrow functions do not pass in "this". In this case it is the this of window.
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions do not pass in this, they obtain their this from their parent scope.
