...
// When joe.scope() is invoked, "this" is a Student Object
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, "this" is the window object
// 3. Explain why "this" is different when an arrow function is used.
// "this" is different when arrow functions are used because arrow functions use lexical scoping.  Basically,
// the arrow function will look at the surrounding code to figure out what this is.  In this case, there is nothing
// around that the arrow function can use and so it uses the window object.
