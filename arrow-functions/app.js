...
// 1. What is "this" when joe.scope() is invoked? this is the instance of the cunstructor function
//
// 2. What is "this" when joe.scopeArrow() is invoked? when using the arrow function the instance of the constructor it will bubble up one layer and return its values.
//
// 3. Explain why "this" is different when an arrow function is used. because when using this the arrow function goes one level up and return the above values.
//
