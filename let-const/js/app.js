...
function displayPics(){
  ...
  // console.log(rando);
  // DONE: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `const to `let`.
  // Trying to log the value of rando threw an error because it is scoped in the displayPics function and not available globally, where it was called
  console.log(viewed);
