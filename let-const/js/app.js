...
function displayPics(){
  ...
  // When I changed rando to a let, it was only defined within the block of the while loop inside displayPics(). Now that rando is only in that block it can't be used outside of the while loop even though its in the same function.
  console.log(viewed);
