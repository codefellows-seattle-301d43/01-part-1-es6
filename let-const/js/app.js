...
function displayPics(){
  ...
  // const is scoped locally so event thought the variable has been assigned it has only been assigned locally the console.log was trying to pull from a variable that didnt exist on a global scale. 
  console.log(viewed);
