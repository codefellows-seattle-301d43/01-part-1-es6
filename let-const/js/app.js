...
function displayPics(){
  ...
  // `let` rando throws an error because it is not hoisted to the top of its scope. `let` is block-scoped while `var` is hoisted. The previous line of code did not know what `rando` was.
  console.log(viewed);
