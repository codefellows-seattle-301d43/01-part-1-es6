...
function displayPics(){
  ...
  // Since const is scoped to the block, it is constrained to displayPics and does not count as a global variable. Since we're trying to call the variable rando outside of the scope of the function, we get an error.
