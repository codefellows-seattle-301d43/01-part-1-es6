...
function displayPics(){
  ...
  // Because we defined rando with const inside the function called displayPics. when we did that, rando became locally scoped to displayPics. So when we called the console.log(rando); it was an undefined value
  console.log(viewed);
