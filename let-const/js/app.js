...
function displayPics(){
  ...
  // var allows it to be hoisted in the function, therefore when you invoke displayPics it allows rando to have a value. const however, will throw an error because it is block scoped.
  console.log(viewed);
